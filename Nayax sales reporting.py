...
## Installs and imports missing packages. From https://stackoverflow.com/a/24773951
...
class GUI():
    ...
    def create_top_menu(self):
        ...
        self.menu_pm.add_command(label = 'Remove unknown products from map', command = self.remove_unknown_products)
        self.menubar.add_cascade(label = 'Products', menu = self.menu_pm)
